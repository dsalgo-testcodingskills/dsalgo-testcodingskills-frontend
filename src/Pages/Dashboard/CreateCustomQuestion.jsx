...
const CreateCustomQuestion = () => {
  ...
  const getCustomQuestion = async () => {
    ...
    console.log("🚀 ~ getCustomQuestion ~ options:", options);
    ...
    if (params.id) {
      ...
      if (res?.data?.data) {
        ...
        if (
          ...
          questionData.constraints.timeLimit < 100
        ) {
          questionData.constraints.timeLimit =
            questionData.constraints.timeLimit * 1000;
        }
          ...
          {({
            ...
            const findFirstErrorPath = (errObj) => {
              ...
              for (const key of Object.keys(errObj)) {
                ...
                if (sub !== null)
                  return `${key}${sub.startsWith("[") ? sub : "." + sub}`;
              }
              return null;
            };
            ...
            const scrollToFieldPath = (fieldPath) => {
              ...
              if (
                !el &&
                (fieldPath === "topics" || fieldPath === "topicInput")
              ) {
              ...
              <Form
                ...
                onSubmitCapture={() => {
                  if (values.topicInput && values.topicInput.trim() !== "") {
                    const newTopic = values.topicInput.trim();
                    if (
                      !values.topics.includes(newTopic) &&
                  ...
                  <div className="question-builder__main">
                    ...
                    <div className="builder-card">
                      <div className="builder-card__header">
                        ...
                        <p className="builder-card__subtitle">
                        ...
                        <div className="row">
                          ...
                          <div className="col-md-6 mb-3">
                            ...
                            <Select
                              ...
                              value={questionsLevelOptions.find(
                                (opt) => opt.value === values.level,
                              )}
                    ...
                    <div className="builder-card">
                      <div className="builder-card__header">
                        ...
                        <p className="builder-card__subtitle">
                          Limits for the code execution environment.
                        </p>
                      </div>
                      <div className="builder-card__body">
                        <div className="row">
                          <div className="col-md-6 mb-3">
                            ...
                            <Field
                              name="constraints.timeLimit"
                              type="number"
                              className="form-control"
                              placeholder="e.g. 2000"
                            />
                            <div className="text-muted small mt-1">
                              Recommended: 1000ms - 15000ms
                            </div>
                            <ErrorMessage
                              name="constraints.timeLimit"
                              render={(msg) => (
                    ...
                    <div className="builder-card">
                      ...
                      <div className="builder-card__body">
                        ...
                        <div className="topic-count mt-2">
                          Tags: <strong>{values.topics.length}</strong> / 5
                        </div>
                        <ErrorMessage
                          name="topics"
                          render={(msg) => (
                    ...
                    <div className="builder-card">
                      <div className="builder-card__header">
                        ...
                        <p className="builder-card__subtitle">
                          Define the input parameters for the solution.
                        </p>
                      </div>
                      <div className="builder-card__body">
                          ...
                          {({ remove, push }) => (
                            <>
                              {values.inputType.map((type, index) => (
                                <div
                                  key={index}
                                  className="parameter-card mb-4 shadow-sm border p-3 rounded-3">
                                  ...
                                  <div className="border-top pt-3 mt-3">
                                    <h6 className="mb-3 small text-uppercase text-muted fw-bold">
                                      Constraints
                                    </h6>
                        ...
                        <div className="row">
                          <div className="col-md-6 text-start">
                            ...
                            <Select
                              ...
                              value={questionTypeOptions.find(
                                (opt) => opt.value === values.outputType,
                              )}
                              onChange={(e) =>
                          ...
                          {({ remove, push }) => (
                            <div>
                              <div className="alert alert-info py-2 px-3 small mb-4">
                                ...
                                Strings must be in double quotes (e.g.
                                &quot;abc&quot;). Arrays should be [1,2,3] or
                                [&quot;a&quot;,&quot;b&quot;].
                              </div>
                              {values.testCases.map((test, index) => (
                                <div
                                  className="test-case-row mb-4 border rounded-3 p-0"
                                  key={index}>
                                    ...
                                    <div className="d-flex align-items-center gap-3">
                                      <div className="form-check mb-0 d-flex align-items-center">
                                        <Checkbox
                                          ...
                                          checked={
                                            values.testCases[index].hidden
                                          }
                                          id={`hidden-${index}`}
                                        />
                                        <label
                                          className="ms-1 mb-0 small"
                                  ...
                                  <div className="test-case-row__body p-3">
                                    <div className="row g-3">
                                      ...
                                      <div className="col-md-4 text-start">
                                        <label className="createCustomQuestion__form-label small">
                                          Expected Output
                                        </label>
                                        <Field
                              ...
                              <div className="d-flex justify-content-end">
                                <button
                                  ...
                                  <i className="fas fa-plus me-2"></i>Add Test
                                  Case
                                </button>
                              </div>
                            </div>
