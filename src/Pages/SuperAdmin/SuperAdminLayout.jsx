      ...
      <div className="sa-sidebar">
        ...
        <ul className="sa-nav">
          ...
          <NavLink to="/super-admin/organisations" activeClassName="active">
            <li><i className="fas fa-building"></i> Organisations</li>
          </NavLink>
          <NavLink to="/super-admin/orders" activeClassName="active">
            <li><i className="fas fa-receipt"></i> Global Orders</li>
          </NavLink>
          <li onClick={() => history.push('/')}><i className="fas fa-arrow-left"></i> Back to Platform</li>
        </ul>
      </div>
